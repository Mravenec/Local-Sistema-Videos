...
CALL spCreateSection('Introducción', 1);  -- Suponiendo que 3 es un admin_id válido
CALL spCreateSection('Módulo 1 Captación de la Oportunidad', 1); 
CALL spCreateSection('Módulo 2 Negociación de la Oportunidad', 1);  -- Suponiendo que 3 es un admin_id válido
CALL spCreateSection('Módulo 3 Monetización', 1);

-- Luego, insertamos un video en esa sección
CALL spInsertVideo('BIENVENIDA', 'https://vimeo.com/896306796?share=copy', 'Contenido del video 1', 1, 1, 1);  -- Suponiendo que 1 es un admin_id válido y 1 es un section_id válido
CALL spInsertVideo('Estructura de negocio', 'https://vimeo.com/896306953?share=copy', 'Contenido del video 2', 2, 1, 1);  -- Suponiendo que 1 es un admin_id válido y 1 es un section_id válido
CALL spInsertVideo('Lo que necesitas para iniciar', 'https://vimeo.com/896307919?share=copy', 'Contenido del video 3', 3, 1, 1);
CALL spInsertVideo('Mi historia', 'https://vimeo.com/896308935?share=copy', 'Contenido del video 4', 4, 1, 1);

CALL spInsertVideo('Captacion Oportunidad', 'https://vimeo.com/896306881?share=copy', 'Contenido del video 5', 1, 2, 1);
CALL spInsertVideo('Metodo 1 Publicidad Digital', 'https://vimeo.com/896310151?share=copy', 'Contenido del video 6', 2, 2, 1);
CALL spInsertVideo('Metodo 2 Lista Caliente', 'https://vimeo.com/896311328?share=copy', 'Contenido del video 7', 3, 2, 1);
CALL spInsertVideo('Metodo 3 Remates', 'https://vimeo.com/896314159?share=copy', 'Contenido del video 8', 4, 2, 1);
CALL spInsertVideo('Metodo 4 Gruas', 'https://vimeo.com/896314159?share=copy', 'Contenido del video 9', 5, 2, 1);
CALL spInsertVideo('Metodo 5 Visitar Talleres', 'https://vimeo.com/896314159?share=copy', 'Contenido del video 10', 6, 2, 1);
CALL spInsertVideo('Metodo 6 Captación en el momento', 'https://vimeo.com/896319338?share=copy', 'Contenido del video 11', 7, 2, 1);
CALL spInsertVideo('Metodo 7 App 0 Riesgo', 'https://vimeo.com/896319338?share=copy', 'Contenido del video 12', 8, 2, 1);
CALL spInsertVideo('Metodo 8 Rent a Car', 'https://vimeo.com/896322938?share=copy', 'Contenido del video 13', 9, 2, 1);
CALL spInsertVideo('Metodo 9 Referidos', 'https://vimeo.com/896323560?share=copy', 'Contenido del video 14', 10, 2, 1);

CALL spInsertVideo('Cálculo de Salvamiento', 'https://vimeo.com/896307033?share=copy', 'Contenido del video 15', 1, 3, 1);
CALL spInsertVideo('Cuando no es negocio', 'https://vimeo.com/896309728?share=copy', 'Contenido del video 16', 2, 3, 1);
CALL spInsertVideo('Finalización del trámite', 'https://vimeo.com/896311069?share=copy', 'Contenido del video 17', 3, 3, 1);
CALL spInsertVideo('Lista de Contactos', 'https://vimeo.com/896312153?share=copy', 'Contenido del video 18', 4, 3, 1);
CALL spInsertVideo('Llamada de Oferta', 'https://vimeo.com/896313527?share=copy', 'Contenido del video 19', 5, 3, 1);
CALL spInsertVideo('Manejo de Objeciones', 'https://vimeo.com/896314533?share=copy', 'Contenido del video 20', 6, 3, 1);
CALL spInsertVideo('Preguntas clave', 'https://vimeo.com/896316329?share=copy', 'Contenido del video 21', 7, 3, 1);
CALL spInsertVideo(' Seguimiento', 'https://vimeo.com/896325218?share=copy', 'Contenido del video 22', 8, 3, 1);

CALL spInsertVideo('Buscar Taller', 'https://vimeo.com/896307157?share=copy', 'Contenido del video 23', 1, 4, 1);
CALL spInsertVideo('Checklist', 'https://vimeo.com/896312530?share=copy', 'Contenido del video 24', 2, 4, 1);
CALL spInsertVideo('Comunidad', 'https://vimeo.com/896312967?share=copy', 'Contenido del video 25', 3, 4, 1);
CALL spInsertVideo('Contactos Extranjero', 'https://vimeo.com/896314238?share=copy', 'Contenido del video 26', 4, 4, 1);
CALL spInsertVideo('Cotización de repuestos', 'https://vimeo.com/896314535?share=copy', 'Contenido del video 27', 5, 4, 1);
CALL spInsertVideo('Diego Venegas', 'https://vimeo.com/896327439?share=copy', 'Contenido del video 28', 6, 4, 1);
CALL spInsertVideo('Opción 1 Comisión', 'https://vimeo.com/896327666?share=copy', 'Contenido del video 29', 7, 4, 1);
CALL spInsertVideo('Opción 2 Comisión y Diferencial', 'https://vimeo.com/896327918?share=copy', 'Contenido del video 30', 8, 4, 1);
CALL spInsertVideo('Opcion 3 Contado, Crédito, Inversionista', 'https://vimeo.com/896328483?share=copy', 'Contenido del video 31', 9, 4, 1);
CALL spInsertVideo('Panamá', 'https://vimeo.com/896328995?share=copy', 'Contenido del video 32', 10, 4, 1);
CALL spInsertVideo('Proceso de Venta', 'https://vimeo.com/896329103?share=copy', 'Contenido del video 33', 11, 4, 1);
CALL spInsertVideo('Reparación', 'https://vimeo.com/896329462?share=copy', 'Contenido del video 34', 12, 4, 1);
CALL spInsertVideo('Repuestos en Alibaba', 'https://vimeo.com/896329734?share=copy', 'Contenido del video 35', 13, 4, 1);
CALL spInsertVideo('Traer repuestos de manera virtual', 'https://vimeo.com/896330111?share=copy', 'Contenido del video 36', 14, 4, 1);
